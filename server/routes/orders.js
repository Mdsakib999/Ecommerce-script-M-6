...
const { createOrder, getOrderById, getAllOrders, updateToDelivered, updateOrderStatus, getMyOrders } = require('../controllers/orderController');
...
router.get('/my-orders', verifyFirebaseToken, getMyOrders); // User's own orders
